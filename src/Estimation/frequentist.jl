"""
  quantfreq(y, X, Control, sigma, p, tau)

Estimates the parameters of the SEPD likelihood by maximization. The Control dictionary should be specified as.
```julia
control = Dict(
    :tol => 1e-3,
    :max_iter => 1000,
...
# Arguments
- `y::AbstractVector{<:Real}`: dependent data
- `X::AbstractMatrix{<:Real}`: model matrix
- `Control::Dict{Symbol, Real}`: dictionary that translates to list for the Rcode
